...
MapUtils:AddTrans("koKR", "LID_FISHINGLEVELS", "월드맵에 지역별 최소 낚시 숙련도 표시")
...
MapUtils:AddTrans("koKR", "LID_PIERS", "선착장, 비행선 및 지하철")
MapUtils:AddTrans("koKR", "LID_RAIDENTRANCE", "공격대 입구")
...
MapUtils:AddTrans("koKR", "LID_TRAMTO", "지하철 목적지")
